...
const Categories = () => {
    ...
    const fetchCategories = async (withLoader = false) => {
        try {
            setApiError("");
            ...
            setApiError(error?.message || "Failed to fetch categories");
        } finally {
            setLoading(false);
    ...
    const handleDelete = async (row) => {
        ...
        try {
            ...
            await deleteData(`/categories/${row.id}`);
                    ...
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell sx={headCellSx}>Parent</TableCell>
                                    ...
                                    <TableRow key={row.id} hover>
                                        ...
                                        <TableCell sx={bodyCellSx}>
                                            <Typography color="text.secondary">
                                                {row.parentCategory?.name || row.parentId || "-"}
                                            </Typography>
                                        </TableCell>
