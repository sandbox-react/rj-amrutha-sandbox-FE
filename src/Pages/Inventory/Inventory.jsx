...
const Inventory = () => {
    ...
    const handleUpdateStock = async (row) => {
        const value = window.prompt("Enter new stock value", row.stock);
        ...
        try {
            ...
            await patchData(`/inventory/variants/${row.id}/stock`, {
                stock: Number(value)
            });
    ...
    const metricCards = useMemo(() => {
        return [
            ...
            },
            {
                ...
                subValue: "▼ Reorder soon",
                subColor: colors.red,
                topColor: colors.gold,
                iconBg: colors.softGold,
                icon: <WarningAmberOutlinedIcon sx={{ color: colors.gold }} />
            },
            {
                title: "Out of Stock",
                ...
                icon: <BlockOutlinedIcon sx={{ color: colors.red }} />
            }
        ];
    }, [summary]);
                                    ...
                                    rows.map((row) => {
                                        ...
                                        return (
                                            <TableRow key={row.id} hover>
                                                ...
                                                <TableCell sx={bodyCellSx}>
                                                    <Typography color={colors.heading}>
                                                        {row.categoryName}
                                                    </Typography>
                                                </TableCell>
